...
export default async function AdminPage() {
  ...
  const [
    ...
    adminAny.from('profiles').select('id, first_name, last_name, email, username, gender, is_admin, admin_role, admin_permissions, is_verified, is_elite, is_suspended, subscription_tier, subscription_expires_at, subscription_plan, created_at').order('created_at', { ascending: false }),
