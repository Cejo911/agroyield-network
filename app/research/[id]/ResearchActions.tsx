...
export default function ResearchActions({ id }: { id: string }) {
  ...
  return (
    <div className="flex gap-3 mt-6">
      <a href={`/research/${id}/edit`} className="flex-1 text-center py-2.5 rounded-lg border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">✏️ Edit</a>
      {!confirming ? (
        <button
