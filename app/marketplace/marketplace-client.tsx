...
const getCategoryColour = (category: string | null) =>
  category ? (CATEGORY_COLOURS[category] ?? 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400') : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400'
      ...
      {filtered.length === 0 ? (
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {filtered.map(listing => (
            <div key={listing.id} className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-md hover:border-green-200 dark:hover:border-green-800 transition-all group flex flex-col">
              ...
              <div className="px-5 pb-4 pt-3 border-t border-gray-100 dark:border-gray-800 flex items-center gap-4">
