  ...
  return (
    <div className="mt-6 pt-6 border-t border-gray-100 dark:border-gray-800">
      ...
      <div className="flex gap-3">
          ...
          className="flex-1 text-center py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
        >
          ✏️ Edit Listing
        </a>
        ...
        {!confirming ? (
          <button
            ...
            className="flex-1 py-2.5 rounded-lg border border-red-300 dark:border-red-800 text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
          >
            🗑️ Delete Listing
          </button>
        ) : (
