...
export default function OpportunityActions({ id }: { id: string }) {
  ...
  return (
    <div className="mt-6 pt-6 border-t border-gray-100 dark:border-gray-800">
      <p className="text-xs text-gray-400 dark:text-gray-500 mb-3 font-medium uppercase tracking-wide">Manage your post</p>
      <div className="flex gap-3">
        <a href={`/opportunities/${id}/edit`} className="flex-1 text-center py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
          ✏️ Edit Opportunity
        </a>
        {!confirming ? (
