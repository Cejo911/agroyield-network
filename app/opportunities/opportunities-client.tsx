  ...
  if (initial.length === 0) {
    return (
      <EmptyState
        ...
        body="Jobs, internships, calls for proposals and more — be the first to post one for the network."
        action={<PrimaryLink href="/opportunities/new">Post a new opportunity</PrimaryLink>}
      />
    )
  }
    ...
    <div className="space-y-4">
      ...
      {sorted.length === 0 ? (
        <EmptyState
          ...
          body="Try different keywords or clear the filter to see every open opportunity."
          action={<PrimaryLink href="/opportunities/new">Post a new opportunity</PrimaryLink>}
          secondaryAction={
            <button
              type="button"
